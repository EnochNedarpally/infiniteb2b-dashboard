...
import VendorAddWhitepaper from "../pages/vendorModule/Whitepaper/AddWhitepapers";
import VendorAllWhitepapers from "../pages/vendorModule/Whitepaper/AllWhitepapers ";
...
const authProtectedRoutes = [
  ...
  // { path: "/apps-crm-companies", component: <MostDownloadedPDFList/> },
  ...
  { path: "/add-whitepapers", component: <AddWhitepaper /> }, 
  { path: "/all-whitepapers", component: <AllWhitepapers /> }, 
  ...
  { path: "/all-campaign", component: <AllCampaign /> },
  //NewsLetters
  ...
  //uses
  { path: "/user-addadmin", component: <AddAdmin/> },
  { path: "/user-alladmin", component: <AllAdmin/> },
  { path: "/user-addcampaign-managers", component: <AddCampaignManagers/> },
  { path: "/user-allcampaign-managers", component: <AllCampaignManagers/> },
  { path: "/user-addeditors", component: <AddEditors /> },
  { path: "/user-alleditors", component: <AllEditors /> },

  //Vendors
  { path: "/review-vendor", component: <ReviewVendor/> },
  { path: "/all-vendors", component: <AllVendors/> },
...
{ path: "/user/newsletter-subsciber", component: <NewsletterSubsciber /> }, 
