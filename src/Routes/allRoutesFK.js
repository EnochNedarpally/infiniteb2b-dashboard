...
const authProtectedRoutes = [
  ...
  {
    path: "/admin/user-addcampaign-managers",
    component: <AddCampaignManagers />,
  },
  {
    path: "/admin/user-allcampaign-managers",
    component: <AllCampaignManagers />,
  },
  { path: "/admin/user-addeditors", component: <AddEditors /> },
  { path: "/admin/user-alleditors", component: <AllEditors /> },

  //Vendors
  { path: "/admin/review-vendors", component: <ReviewVendor /> },
