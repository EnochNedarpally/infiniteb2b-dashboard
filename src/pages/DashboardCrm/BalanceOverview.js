...
//                         <h4 className="card-title mb-0 flex-grow-1">Total Visitors</h4>
...
//                             <BalanceOverviewCharts series={chartData} dataColors='["--vz-success", ""]'/>
//                         </div>
//                     </CardBody>
//                 </Card>
//             </Col>
...
const TotalVisitors = () => {
    ...
    return (
        <React.Fragment>
            <Col xxl={12} className="d-flex">
                <Card className="card-height-100 w-100">
                    <CardHeader className="border-0 align-items-center d-flex">
                        <h4 className="card-title mb-0 flex-grow-1">Total Visitors</h4>
                    </CardHeader>
                    <CardBody className="px-0" style={{ height: "100%" }}>
                        <div id="revenue-expenses-charts" dir="ltr">
                            <BalanceOverviewCharts 
                               series={[
                                {
                                    name: "Visitors", // Label for the line
                                    data: [110, 120, 115, 125, 230, 120, 135] // Example data points
                                }
                            ]}
                            // series={chartData} 
